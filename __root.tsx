...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Gestão de Diaristas" },
      { property: "og:title", content: "Gestão de Diaristas" },
      { property: "og:description", content: "Cadastro, escala, EPIs e financeiro dos seus diaristas." },
